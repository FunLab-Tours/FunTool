...
<form method="POST" action="">
    ...
    <div>
        <?=$lang["firstName"]?> : <input type="text" name="firstName" value="<?=$user['firstName']?>"/>

    </div>
    <div>
        <?=$lang["name"]?> : <input type="text" name="name" value="<?=$user['name']?>"/>
    </div>
    <div>
        <?=$lang["telephone"]?> : <input type="tel" name="telephone" value="<?=$user['telephone']?>"/>
    </div>
    <div>
        <?=$lang["adress"]?> :  <input type="text" name="adressL1" value="<?=$user['adressL1']?>"/>
                                <input type="text" name="adressL2" value="<?=$user['adressL2']?>"/>
                                <input type="text" name="adressL3" value="<?=$user['adressL3']?>"/>
    </div>
    <div>
        <?=$lang["zipCode"]?> : <input type="number" name="zipCode" value="<?=$user['zipCode']?>"/>
    </div>
    <div>
        <?=$lang["town"]?> : <input type="text" name="town" value="<?=$user['town']?>"/>
    </div>
    <div>
        <?=$lang["country"]?> : <input type="text" name="country" value="<?=$user['country']?>"/>
    </div>
    <div>
        <?=$lang["email"]?> : <input type="email" name="email" value="<?=$user['email']?>"/>
    </div>
    <div>
        <?=$lang["emailBis"]?> : <input type="email" name="emailBis" value="<?=$user['emailBis']?>"/>
    </div>
    <div>
        <?=$lang["birthDate"]?> : <input type="date" name="birthDate" value="<?=$user['birthDate']?>"/>
    </div>
    <div>
